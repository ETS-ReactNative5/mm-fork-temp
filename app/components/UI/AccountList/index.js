...
class AccountList extends PureComponent {
	static propTypes = {
		...
		onConnectLedger: PropTypes.func,
		/**
			...
			<SafeAreaView style={styles.wrapper} testID={'account-list'}>
				...
				{enableAccountsAddition && (
					<View style={styles.footer}>
						...
						<TouchableOpacity
							onPress={this.connectLedger}
							style={styles.footerButton}
							testID={'import-account-button2'}
						>
							<Text style={styles.btnText}>Connect Ledger</Text>
						</TouchableOpacity>
					</View>
				)}
			</SafeAreaView>
